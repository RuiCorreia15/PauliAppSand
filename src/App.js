...
const firebaseConfig = {
  apiKey: "AIzaSyCk2MXN1LpqP1W1OJqIJ97cG1rwEfG1Wv4",
  authDomain: "paulicare-aa24d.firebaseapp.com",
  projectId: "paulicare-aa24d",
  storageBucket: "paulicare-aa24d.firebasestorage.app",
  messagingSenderId: "712970391906",
  appId: "1:712970391906:web:5fd6f44edb1d2939d05c3b",
};
  ...
  const steps = [
    ...
    >
      ...
      <Card style={{ marginBottom: 20 }}>
        ...
        >
          10 mg · {t("maxPerDay")} 4{t("perDay")}
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          <Badge
            label={`${t("maxPerDay")} 4${t("perDay")}`}
            color={T.red}
            bg={T.redLt}
          />
          <Badge label="With water" />
        </div>
      </Card>
    ...
    >
      ...
      <Card style={{ background: T.redLt, border: `1.5px solid #F5C0C0` }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <span style={{ fontFamily: T.sans, fontSize: 12, color: "#B03030" }}>
            10mg · {t("maxPerDay")} 4{t("perDay")}
          </span>
        </div>
      </Card>
    </div>
...
export default function App() {
  ...
  const screens = {
    ...
    onboarding: <Onboarding onComplete={handleOnboarding} />,
    home: <Home go={setScreen} events={events} />,
    meds: (
      <Medication go={setScreen} events={events} onTakeMed={handleTakeMed} />
    ),
    sosTab: <SOSTab go={setScreen} events={events} />,
    symptoms: (
      <Symptoms
        go={setScreen}
        events={events}
